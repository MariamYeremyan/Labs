...
#script for printing if the given number is positive or negative
...
#if the given number is divisable 2, 3 or 5
...
chmod +rwx new_file.txt #add permission of execution


#6
[ -d dir ] || mdir dir #check if there is a dir directory
...
#script to check if the number is in the given range
...
#script that is getting the word "Secret" and is checking if it is matching or not
...
#script that is getting a file name as a value 
