...
#is getting the name of month and printing how many days there are in tha month
...
#is ggetting file name and checking if it exists and have permission, prints the content
...
#the copy of file without cp command
...
#is getting 2 numbers and printing the sum of 2 numbers
...
#is getting values and is printing all
...
#is getting numbers and printing the number of even numbers